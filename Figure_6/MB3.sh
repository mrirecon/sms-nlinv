...
###
    # aligned
bart traj -x 384 -y 29 -t 1 -m 3 -l -D1 -q -0.614225:-0.651670:-0.000881 traja
    # oversampling
...
bart scale 2 trajt trajt_os
    ...
    # golden-angle
bart traj -x 384 -y 29 -t 1 -m 3 -g -D1 -q -0.614225:-0.651670:-0.000881 trajg
    # oversampling
...
bart transpose 1 2 kMB3_aligned_SP29 ka2
...
bart transpose 1 2 kMB3_ga_SP29 kg2
...
bart resize -c 0 192 1 192 reco_a_tmp MB3_aligned_SP29
bart resize -c 0 192 1 192 reco_t_tmp MB3_turn_SP29
bart resize -c 0 192 1 192 reco_g_tmp MB3_ga_SP29
