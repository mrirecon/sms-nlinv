...
# 69 spokes
    # aligned
bart traj -x 384 -y 69 -t 1 -m 2 -l -D1 -q -0.614225:-0.651670:-0.000881 trajaM
    # oversampling
bart scale 2 trajaM trajaM_os

    # turn-based
bart traj -x 384 -y 69 -t 1 -m 2 -D1 -q -0.614225:-0.651670:-0.000881 trajtM
    # oversampling
bart scale 2 trajtM trajtM_os

    # golden-angle
bart traj -x 384 -y 69 -t 1 -m 2 -g -D1 -q -0.614225:-0.651670:-0.000881 trajgM
    # oversampling
